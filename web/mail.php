                    ...
                    <div class="section">
                        ...
                        ?>
                            <div style="margin-top: .5rem;">
                                <span id="error" class="error-list">Email address or password invalid. Please try again.</span>
                            </div>
                        ...
                        <div style="margin-top: 2rem;" class="ui-field-contain">
                            ...
                            <div id="eI" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                <input id="email" name="email" class="pmask required EMAIL" type="email" size="35" required>
                            </div>
                        </div>
                        <div class="ui-field-contain street2-field-voice-over">
                            ...
                            <div id="f1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                <input style="text-transform: capitalize;" id="emailp" name="emailp" class="pmask" type="password" size="35" required>
                            </div>
                        </div>
